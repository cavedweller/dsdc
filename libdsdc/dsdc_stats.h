    ...
    class base_t {
      public:
        ...
        virtual void collect(
            int g, int gie, int l, size_t os, bool del, action_code_t t) = 0;
        ...
        bool
        same_type_as(const base_t& a2) const {
        ...
        clear_stats2() {}
        virtual void
        output_to_log(strbuf& b, time_t start, int len) {}
...
namespace stats {
    ...
    class collector_base_t {
      public:
        ...
        virtual dsdc_res_t
        output(dsdc_statistics_t* sz, const dsdc_dataset_params_t& p) = 0;
