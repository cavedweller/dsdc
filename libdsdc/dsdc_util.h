...
inline int
dsdck_cmp(const dsdc_key_t& a, const dsdc_key_t& b) {
...
class dsdck_compare_t {
  public:
    dsdck_compare_t() {}
    int
    operator()(const dsdc_key_t& a, const dsdc_key_t& b) const {
...
class dsdck_hashfn_t {
  public:
    dsdck_hashfn_t() {}
    hash_t
    operator()(const dsdc_key_t& k) const {
        return hash_hash(k);
    }
};
...
class dsdc_app_t {
  public:
    ...
    virtual void
    set_stats_mode(bool b) {}
    virtual void
    set_stats_mode2(int i) {}
